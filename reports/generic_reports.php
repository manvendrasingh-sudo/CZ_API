...
$filterObj->setFilterCondition($current_date, $startdate, $enddate, $starttime, $endtime, $startduration, $endduration, $id, $agent_id, $list_id, $disposition, $campaign_type, $dialer_type, $cust_disposition, $customer_ph, $unique_calls, $magic_call, $ivr_node_name, $did , $ivr_report, $permissible_ivr,$camp_name);

$REPORT = $report->setReportFields($obj, $config, $filterObj, $report_name, $current_date, $dwnl_reports_flag, $report_user_name, $table_name);
